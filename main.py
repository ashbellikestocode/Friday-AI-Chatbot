...
# Making a wake up function that will listen for the wake word and then respond accordingly. 
...
#Processing the command and responding accordingly.
...
def process_command(command):
                if "hi"in command or "hello" in command or "hey friday" in command:         
                    ...
                    a = print("I am sorry, I can only respond to 'hello', 'what is your name', 'how are you', 'hey friday', and 'goodbye' as wake words. Please try again.")
